...
<head>
    ...
    <script src="skryptAddRiddle.js"></script>
...
<body>
	...
	<div class="container" id="container">
		...
		<div id="header" class="text-center">Add riddle</div>
			...
			<form class="sendForm text-center" method="post" name="formAddRiddle">
				...
				<input class="input" type="text" name="category" placeholder="Category" onfocus="this.placeholder=''" onblur="this.placeholder='Category'"
				value="<?php
		...
		?>"/>
				...
				<textarea class="input txtArea"  type="textarea" name="description" placeholder="Description" onfocus="this.placeholder=''" onblur="this.placeholder='Description'" >
<?php
				...
				<textarea class="input txtArea" type="textarea" name="sentence" placeholder="Riddle" onfocus="this.placeholder=''" onblur="this.placeholder='Riddle'">
<?php
				...
				?>
					...
					<br>
					<input class="input" type="number" name="level" min="0" max="20" placeholder="Level (0-20)" onfocus="this.placeholder=''" onblur="this.placeholder='Level (0-20)'"
				value="<?php
		...
		?>"/>
				...
				<br>
				<br>
				<button class="btn btn-danger button" onclick="reset();" id="resetBtn">Clear the form <span class="glyphicon glyphicon-remove-circle"></span></button>
				<button type="submit" class="btn btn-success button">Add riddle <span class="glyphicon glyphicon-plus-sign"></span></button>
